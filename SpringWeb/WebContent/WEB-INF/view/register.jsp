			...
			<form:form action="add" method="post"  commandName="p">
				...
				<div align="center">
					...
					<table align="center" border="2" height="500px" width="70%">
						...
						<trbgcolor="#99ff66" class="required">
							<th align="left"><b>Visible Distinguishing Mark (If
									any?)</b></th>
							<th>1.<form:input 
									path="visible1"  /><br>
							<br> 2.<form:input 
									name="visible2" path="visible2"  /><br>
							<br></th>
						</tr>
						...
						<tr bgcolor="#99ff66">
							...
							<th><form:input type="number" path="pancard"
					 /></th>
						</tr>
						<br>
						<br>
						...
						<th colspan="2"><input type="submit" path="submit"value="NEXT PAGE"/><br>
...
<table align="center" border="2" height="500px" width="70%">
						<tr bgcolor="orange">
							<th colspan="2"><h3 align="center">Required Details</h3>
						</tr>
				...
				<th><Form:input path="password2" name=password2
						title="it should same as password" required /></th>
			</tr>
			<br>
			<br>
